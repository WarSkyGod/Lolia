...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("top.craft_hello.lolia:lolia-api")
...
paperweight {
    serverProject.set(project(":lolia-server"))
    ...
    useStandardUpstream("folia") {
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("Lolia-API"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("Lolia-Server"))
        }
    }
}
